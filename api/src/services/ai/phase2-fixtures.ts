...
export const PHASE2_COVER_FIXTURES: readonly Phase2CoverFixture[] = [
  {
    ...
    author: '林下客',
    prompt: '',
    description: '雨夜里，旧巷尽头的灯笼映出一把透明雨伞，主人公在等待一封迟到的信。',
    categories: ['现代言情'],
    promptMode: 'auto',
    renderTitle: true,
    stylePreset: 'soft_watercolor',
    composition: 'environment',
    expectedProviderCalls: { text: 2, image: 1 },
  },
  {
  ...
  },
  {
    ...
    author: '闻舟',
    prompt: '',
    description: '两个人在借住的旧屋里共同修复一件带有月纹的物件，却因为一段未说出口的往事保持距离。',
    categories: ['现代言情'],
    promptMode: 'auto',
    renderTitle: true,
  ...
  },
  {
    ...
    author: '青简',
    prompt: '',
    description: '主人公沿着旧地图回到山城，长桥和河面保存着一段家族迁徙的记忆。',
    categories: ['历史'],
    promptMode: 'auto',
    renderTitle: true,
  ...
  },
  {
    ...
    author: '沈砚',
    prompt: '',
    description: '旧铜哨是码头失踪案留下的唯一证物，潮声变大时它会在木桌上轻轻震动。',
    categories: ['悬疑'],
    promptMode: 'auto',
    renderTitle: false,
  ...
  },
  {
    ...
    description: '一封没有寄出的春日信件留在旧木窗边，桌面水痕和花影记录着一次没有说出口的告别。',
    categories: ['现代言情'],
    promptMode: 'exact',
    renderTitle: false,
