...
export const GENRE_STYLES: Record<Genre, GenreStyle> = {
  xianxia: {
    ...
    figure: 'a premise-led central subject or character, described through a grounded gesture, silhouette, and one relevant prop',
    background: 'an atmosphere and location inferred from the premise, with layered depth and one memorable environmental cue',
  ...
  urban: {
    ...
    figure: 'a premise-led contemporary protagonist shown through a specific gesture, expression, and grounded personal detail',
    background: 'a concrete modern location drawn from the premise, with readable depth and one story-relevant environmental cue',
  ...
  ancient: {
    tag: 'ancient Chinese romance and classical drama, elegant restrained beauty',
    figure: 'a period-appropriate subject only when supported by the premise, shown through posture, fabric, and one grounded object',
    background: 'a historically grounded setting taken from the premise, with restrained architecture and a clear spatial anchor',
  ...
  mystery: {
    ...
    figure: 'a premise-led figure, partial view, or consequential object that keeps identity and intent partly concealed',
    background: 'a specific investigation location drawn from the premise, with evidence-bearing depth and controlled shadow',
  ...
  scifi: {
    ...
    figure: 'a premise-led subject or machine interface described through function, gesture, and one story-relevant technological detail',
    background: 'a specific future location inferred from the premise, with layered scale and one readable technological cue',
  ...
  fantasy: {
    ...
    figure: 'a premise-led traveler, creature, or symbolic subject shown through a distinct silhouette and grounded action',
    background: 'a world location supported by the premise, with layered scale and one memorable environmental landmark',
  ...
  historical: {
    ...
    figure: 'a premise-led historical subject shown through duty, posture, material, and one verifiable object',
    background: 'a historically grounded location from the premise, with spatial depth and restrained period detail',
  ...
  horror: {
    ...
    figure: 'a premise-led person, absence, or unsettling trace whose identity remains partially obscured',
    background: 'a specific place supported by the premise, with quiet depth and one disturbing environmental detail',
  ...
  light: {
    ...
    figure: 'a premise-led character or mascot expressed through a clear silhouette, gesture, and one playful prop',
    background: 'a specific lighthearted setting drawn from the premise, with one readable environmental cue',
